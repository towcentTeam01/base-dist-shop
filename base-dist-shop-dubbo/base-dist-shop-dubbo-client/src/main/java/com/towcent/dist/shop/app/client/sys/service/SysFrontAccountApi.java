package com.towcent.dist.shop.app.client.sys.service;
...
public interface SysFrontAccountApi {
     ...
     * @throws RpcException
     */
    SysFrontAccount loginForMiniApp(Integer merchantId, String code, String encryptedData, String iv, byte appType, Integer parentUserId) throws RpcException;
	
    SysFrontAccount loginForWx(Integer merchantId, String code, byte appType, Integer parentUserId) throws RpcException;
     ...
     * @version 0.1.0
     */
    boolean mobileIsExist(Integer merchantId, String mobile, byte appType) throws RpcException;
     ...
     * @version 0.1.0
     */
    boolean emailIsExist(Integer merchantId, String email, byte appType) throws RpcException;
     ...
     * @version 0.1.0
     */
    boolean accountIsExist(Integer merchantId, String account, byte appType) throws RpcException;
     ...
     * @return: boolean 
     */
    boolean register(Integer merchantId, String phone, String password, byte appType, Integer parentUserId) throws RpcException;
