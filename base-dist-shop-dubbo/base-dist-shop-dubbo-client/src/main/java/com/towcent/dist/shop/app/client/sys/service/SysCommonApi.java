...
public interface SysCommonApi {
     ...
     * @throws RpcException
     */
    SysAbout getSysAboutByType(Integer merchantId, byte appType) throws RpcException;
     ...
     */
    PaginationDto<MessageMailVo> getMessageMailByPage(Integer merchantId, Integer userId, String type, Byte appType, SimplePageDto pageDto) throws RpcException;
	 ...
	 * @throws RpcException
	 */
	List<SysCarouselConf> getCarouselList(Integer merchantId, String carouselType) throws RpcException;
	
	/**
	 * 发送微信小程序模板消息.
	 * @Title sendAppletMessage
	 * @param merchantId 商户Id
	 * @param vo         消息Vo 
	 * @return
	 * @throws RpcException
	 */
	boolean sendAppletMessage(Integer merchantId, WxMaTemplateMessage vo) throws RpcException;
	
	/**
	 * 发送微信公众号模板消息(必须要求是已认证的服务号).
	 * @Title sendWxTemplateMessage
	 * @param merchantId 商户Id
	 * @param vo         消息Vo
	 * @return
	 * @throws RpcException
	 */
	boolean sendWxTemplateMessage(Integer merchantId, WxMpTemplateMessage vo) throws RpcException;
