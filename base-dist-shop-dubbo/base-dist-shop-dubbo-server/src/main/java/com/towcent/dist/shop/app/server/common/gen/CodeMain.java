 ...
 */
package com.towcent.dist.shop.app.server.common.gen;
...
public class CodeMain {
	...
	public static void main(String[] args) {		
		ApplicationContext context = new ClassPathXmlApplicationContext("classpath:META-INF/spring-context.xml", "classpath:META-INF/spring-context-jms.xml");
