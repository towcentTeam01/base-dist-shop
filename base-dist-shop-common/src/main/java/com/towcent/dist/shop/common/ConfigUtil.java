...
public class ConfigUtil implements InitializingBean {
	...
	public static String getLocalUrlHeader() {
		return map.get("localUrlHeader");
	}
	...
	public void afterPropertiesSet() throws Exception {
		...
		map.put("localUrlHeader", localUrlHeader);
	...
	@Value("${image.local.url.header}")
	private String localUrlHeader;
