...
import com.towcent.dist.shop.portal.sys.biz.AboutService;
import com.towcent.dist.shop.portal.sys.vo.input.AboutIn;
import com.towcent.dist.shop.portal.sys.vo.output.AboutOut;
...
public class AboutServiceImpl extends BasePortalService implements AboutService {
    ...
    public ResultVo about(AboutIn paramIn) {
        ...
        try {
            ...
            SysAbout about = sysCommonApi.getSysAboutByType(paramIn.getMerchantId(), Constant.APP_TYPE_0);
            if (about == null) {
