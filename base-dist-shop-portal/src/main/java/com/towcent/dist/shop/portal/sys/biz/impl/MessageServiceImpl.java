...
import com.towcent.dist.shop.portal.sys.biz.MessageService;
...
public class MessageServiceImpl extends BasePortalService implements MessageService {
	...
	public ResultVo list(MessageListIn paramIn) {
		...
		try {
			...
			PaginationDto<MessageMailVo> outPage = sysCommonApi.getMessageMailByPage(paramIn.getMerchantId(), account.getId(), paramIn.getType(),
