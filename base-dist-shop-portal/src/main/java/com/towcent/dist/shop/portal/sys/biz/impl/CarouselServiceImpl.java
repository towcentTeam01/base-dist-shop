...
import com.towcent.dist.shop.portal.sys.biz.CarouselService;
import com.towcent.dist.shop.portal.sys.vo.input.CarouselListIn;
import com.towcent.dist.shop.portal.sys.vo.output.CarouselListOut;
...
public class CarouselServiceImpl extends BasePortalService implements CarouselService {
    ...
    public ResultVo list(CarouselListIn paramIn) {
        ...
        try {
            ...
            List<SysCarouselConf> list = sysCommonApi.getCarouselList(paramIn.getMerchantId(), paramIn.getCarouselType());
            if (list != null) {
