...
import com.towcent.dist.shop.portal.sys.biz.AppService;
...
import com.towcent.dist.shop.portal.sys.vo.output.AppTestFlagOut;
import com.towcent.dist.shop.portal.sys.vo.output.AppValidateVersionOut;
...
public class AppServiceImpl extends BasePortalService implements AppService {
    ...
    public ResultVo validateVersion(AppValidateVersionIn paramIn) {
        ...
        try {
            ...
            appVersion.setMerchantId(paramIn.getMerchantId());
    ...
    public ResultVo feedback(AppFeedbackIn paramIn) {
        ...
        try {
            ...
            feedBack.setMerchantId(paramIn.getMerchantId());
