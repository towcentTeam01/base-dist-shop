...
public class MemberAccountController extends BaseController {
	...
	// 1.0.1.2  登录接口(公众号)
	@RequestMapping(value = "loginForWx") @Loggable
	public ResultVo loginForWx(@RequestBody MemberAccountLoginForWxIn paramIn) {
		return memberAccountService.loginForWx(paramIn);
	}
	
	// 1.0.1.3  登录接口(小程序)
	@RequestMapping(value = "loginForMiniApp") @Loggable
	public ResultVo loginForMiniApp(@RequestBody LoginIn paramIn) {
		return memberAccountService.loginForMiniApp(paramIn);
	}
