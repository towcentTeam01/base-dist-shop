    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function getNotifyNum(){
                $.get("
            ${ctx}/mail/notifyMail/count?updateSession=0&t="+new Date().getTime(),function(data){
				...
				if (num > 0){
					...
					if(mindNum == 0){
						...
						var html = '您有'+num+'个未读消息，<a href="
            ${ctx}/mail/notifyMail?appType=2&isRead=0" id="toMessage12" target="mainFrame">点击这里</a>查看'
...
<div id="main">
        ...
        <div class="navbar-inverse">
            ...
            <ul id="userControl" class="nav navbar-nav pull-right">
                ...
                <li style="line-height:50px;">
                    <img id="userIcon"
                         src='<c:choose><c:when test="${fns:getUserThumbUrl()==null}">${ctxStatic}/images/face_default.png</c:when><c:otherwise>${fns:getUserThumbUrl()}</c:otherwise></c:choose>'/>
                </li>
                <li id="userInfo" class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#"
                       title="个人信息">您好, ${fns:getUser().loginName}(${fns:getUser().name})&nbsp;<span id="notifyNum"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="${ctx}/mail/notifyMail" target="mainFrame"><i class="icon-bell"></i>&nbsp; 我的通知
                            <span id="notifyNum2" class="label label-info hide"></span></a></li>
                        <li><a href="${ctx}/mail/notifyMail?read=1" target="mainFrame">&nbsp; &nbsp;&nbsp; 全部标记已读 </a>
                        </li>
                    </ul>
                </li>
    ...
    <div class="container-fluid">
        ...
        <div id="footer" class="row">
            Copyright &copy; 2015-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a
                href="" target="_blank">天外有天</a> ${fns:getConfig('version')}
        </div>
    </div>
</div>
<script type="text/javascript">
