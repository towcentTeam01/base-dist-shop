...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/images/imageJmsLog/">图片日志列表</a></li>
		<li class="active"><a href="${ctx}/images/imageJmsLog/form?id=${imageJmsLog.id}">图片日志<shiro:hasPermission name="images:imageJmsLog:edit">${not empty imageJmsLog.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="images:imageJmsLog:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="imageJmsLog" action="${ctx}/images/imageJmsLog/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-group">
			...
			<shiro:hasPermission name="images:imageJmsLog:edit">
