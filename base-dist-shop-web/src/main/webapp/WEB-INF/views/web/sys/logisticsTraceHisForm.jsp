...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/logisticsTraceHis/">物流跟踪历史列表</a></li>
		<li class="active"><a href="${ctx}/sys/logisticsTraceHis/form?id=${logisticsTraceHis.id}">物流跟踪历史<shiro:hasPermission name="sys:logisticsTraceHis:edit">${not empty logisticsTraceHis.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:logisticsTraceHis:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="logisticsTraceHis" action="${ctx}/sys/logisticsTraceHis/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<input name="traceTime" type="text" readonly="readonly" maxlength="20" class="form-control input-medium Wdate "
					value="<fmt:formatDate value="${logisticsTraceHis.traceTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<form:input path="location" htmlEscape="false" maxlength="64" class="form-control "/>
			</div>
		</div>
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-3">
			<shiro:hasPermission name="sys:logisticsTraceHis:edit">
