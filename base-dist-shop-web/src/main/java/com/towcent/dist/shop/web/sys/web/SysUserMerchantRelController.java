...
import com.towcent.dist.shop.web.sys.service.SysUserMerchantRelService;
        ...
        try {
            ...
            if (!CollectionUtils.isEmpty(list)) {
                for (SysUserMerchantRel entity : list) {
                    ...
                    map.put("no", entity.getMerchant().getHouseNumber());
                    map.put("name", entity.getMerchant().getShopName());
